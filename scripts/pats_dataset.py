...
class PaTSDataset(Dataset):
    ...
    def __init__(self, dataset_dir: str | Path, split_file_name: str):
        """
        Initializes the PaTSDataset.

        :param dataset_dir: The root directory for a specific number of blocks (e.g., 'data/blocks_4/'). This directory should contain 'trajectories_bin/' and the split file.
    ...
    def _infer_state_dim(self) -> int:
        ...
        traj_path = self.trajectories_bin_dir / f"{first_basename}.traj.bin.npy"
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        ...
        traj_path = self.trajectories_bin_dir / f"{basename}.traj.bin.npy"
        goal_path = self.trajectories_bin_dir / f"{basename}.goal.bin.npy"
